...
CREATE DATABASE IF NOT EXISTS `do_an` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `do_an`;
...
(1, 'thành phố Hà Nội', 'huyện Thanh Oai', 'xã Bình Mình', 'số 19, xóm Lầy, thôn Sinh Liên', NULL, NULL);
...
(2, 'pbkdf2_sha256$320000$KnfLOoziqZsb1xgrHb2QVx$E6vjdz5KZ0Ns3p5aPqbn9HBT5XqBuL7jWccFuHq57zQ=', NULL, 0, '', '', 0, 1, '2022-11-06 15:24:32.000000', 'test@gmail.com', '2000-12-03', 'test', NULL, NULL, 0, 'Male', '2022-11-06 15:24:32.349729', '2022-11-10 17:00:53.307515', NULL, NULL);
